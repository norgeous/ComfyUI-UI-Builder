...
`,c=({promptId:n=void 0,type:p=void 0,node:m=void 0,value:v=void 0,max:j=void 0,images:r=void 0})=>{const{bridge:i}=I.useContext(q),s=p===void 0,l=p==="executing"&&m===null,a=!l&&!s,g=()=>{i.qDelete({promptId:n}),i.updateState("queue",{[n]:void 0})},y=()=>{i.interrupt()},b=()=>{i.updateState("queue",{[n]:void 0})},C=()=>i.updateState("queueSelected",{promptId:n});return e.jsxs(x,{pad:!0,rounded:!0,bgfg:3,style:{display:"inline-flex"},children:[e.jsxs(V,{"aria-label":"Select",onClick:C,style:{width:100,height:40},children:[s&&e.jsx(h,{children:e.jsx(w,{})}),a&&!r&&e.jsx(h,{children:e.jsx(S,{})}),r&&e.jsx(R,{alt:"result",src:`${r[0]}`}),e.jsxs(P,{children:[e.jsx("div",{className:"muted",children:n}),s&&e.jsx("div",{children:"Queued"}),l&&e.jsxs("div",{children:["×",(r==null?void 0:r.length)||0," images"]}),a&&e.jsxs(e.Fragment,{children:[e.jsx("div",{children:m}),e.jsx(k,{value:v,max:j})]})]})]}),e.jsxs(x,{column:!0,children:[s&&e.jsx(u,{lm:!0,text:"Cancel",children:e.jsx(d,{small:!0,"aria-label":"Cancel",onClick:g,children:e.jsx(f,{})})}),a&&e.jsx(u,{lm:!0,text:"Interrupt",children:e.jsx(d,{small:!0,"aria-label":"Interrupt",onClick:y,children:e.jsx(Q,{})})}),l&&e.jsx(u,{lm:!0,text:"Remove",children:e.jsx(d,{small:!0,"aria-label":"Remove",onClick:b,children:e.jsx(f,{})})})]})]})};c.propTypes={promptId:t.string,type:t.string,node:t.string,value:t.number,max:t.number,images:t.arrayOf(t.string)};const F=c;c.__docgenInfo={description:"",methods:[],displayName:"QueueItem",props:{promptId:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"string"},required:!1},type:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"string"},required:!1},node:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"string"},required:!1},value:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"number"},required:!1},max:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"number"},required:!1},images:{defaultValue:{value:"undefined",computed:!0},description:"",type:{name:"arrayOf",value:{name:"string"}},required:!1}}};export{F as c};
