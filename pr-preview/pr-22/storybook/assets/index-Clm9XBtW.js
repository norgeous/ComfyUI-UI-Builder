...
`,f=()=>{var r,i;const s=e.useContext(h),{comfyUrl:d}=e.useContext(I),{formState:m}=e.useContext(v),{config:{baseWorkflow:p}}=e.useContext(B),{objectInfoLoading:b,objectInfoError:x,objectInfo:u}=e.useContext(S),{adapted:g,adaptedComfyWorkflow:C,bodyData:j}=e.useContext(w),[n,t]=e.useState(),y=[{label:"comfyBridge",onClick:()=>t("comfyBridge")},{label:"formState",onClick:()=>t("formState")},{label:"adapted",onClick:()=>t("adapted")},{label:"baseWorkflow",onClick:()=>t("baseWorkflow")},{label:"objectInfo",onClick:()=>t("objectInfo")},{label:"adaptedComfyWorkflow",onClick:()=>t("adaptedComfyWorkflow")},{label:"bodyData",onClick:()=>t("bodyData")}],k={comfyBridge:s,formState:m,adapted:g,baseWorkflow:p,objectInfo:{objectInfoLoading:b,objectInfoError:x,objectInfo:u},adaptedComfyWorkflow:C,bodyData:j}[n];return o.jsxs(G,{children:[o.jsxs(c,{children:[o.jsx(O,{status:(r=s.ws)==null?void 0:r.status}),o.jsxs($,{children:[(i=s.ws)==null?void 0:i.wsStatus," ",d]})]}),o.jsxs(c,{children:[o.jsx(l,{href:"https://github.com/norgeous/ComfyUI-UI-Builder/",target:"_blank",children:o.jsx(D,{"aria-label":"Github"})}),o.jsx(l,{href:"https://norgeous.github.io/ComfyUI-UI-Builder/develop/storybook/",target:"_blank",children:o.jsx(W,{"aria-label":"Storybook"})}),o.jsx(_,{"aria-label":"Debug Data Options",options:y,children:o.jsx(U,{})}),n&&o.jsx(E,{onClick:()=>t(),data:k})]})]})},P=f;f.__docgenInfo={description:"",methods:[],displayName:"StatusBar"};export{P as c};
