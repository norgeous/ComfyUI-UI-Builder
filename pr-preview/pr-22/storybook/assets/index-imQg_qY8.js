...
`,W=b.button`
  ...
  right: 10px;
  z-index: 100;
`,C=({scrollTo:e=!1,onClick:t=()=>{},...r})=>{const n=s.useRef();s.useEffect(()=>{e&&n.current.scrollIntoView()},[e]);const l=i=>{i.stopPropagation(),t()};return a.jsx(U,{...r,ref:n,crossOrigin:"anonymous",onClick:l})};C.propTypes={scrollTo:g.bool,onClick:g.func};C.__docgenInfo={description:"",methods:[],displayName:"Item",props:{scrollTo:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},onClick:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1}}};const D=e=>{const[t,r]=s.useState([512,512]);return s.useEffect(()=>{const n=new Image;n.crossOrigin="anonymous",n.onload=()=>r([n.naturalWidth,n.naturalHeight]),n.src=e},[e]),t},k=8,S=({images:e=[]})=>{const[t,r]=s.useState(!0),[n,l]=s.useState(),[i,R]=s.useState(1),f=s.useRef(),[E,F]=D(e[0]),w=()=>{if(!f.current)return;const{width:u,height:p}=f.current.getBoundingClientRect(),O=e.map((v,y)=>{const h=F/E,m=y+1,j=Math.ceil(e.length/m),T=k*(m-1),N=k*(j-1),M=(u-T)/m,P=(p-N)/j,V=1/h,B=Math.min(E,M,P/h),G=Math.min(F,P,M/V);return B*G}).reduce((v,y,h,m)=>y>m[v]?h:v,0)+1;R(O)};s.useEffect(w,[f,e,E,F]),s.useEffect(()=>(window.addEventListener("resize",w),()=>{window.removeEventListener("resize",w)}),[f,e]);const[z,I]=s.useState(!1);return s.useEffect(()=>{if(!d.isEnabled)return()=>{};const u=()=>{l(d.isFullscreen?n:void 0)};return n!==void 0?(d.request(f.current).then(()=>{setTimeout(()=>I(!0),50)}),d.on("change",u)):(d.exit(),I(!1)),()=>{n!==void 0&&d.off("change",u)}},[n]),e.length?a.jsxs(H,{ref:f,children:[z&&a.jsx(W,{onClick:()=>r(!t),children:t?a.jsx(_,{}):a.jsx(A,{})}),a.jsx(L,{$gapSizePx:k,$columnCount:i,$open:n,onClick:()=>l(void 0),children:e.map((u,p)=>a.jsx(C,{alt:"",src:u,onClick:()=>l(n!==void 0?void 0:p),$open:n,$scaleUp:t,scrollTo:z&&n===p},u))})]}):null};S.propTypes={images:g.arrayOf(g.string)};const ee=S;S.__docgenInfo={description:"",methods:[],displayName:"ImageGrid",props:{images:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"arrayOf",value:{name:"string"}},required:!1}}};export{ee as c};
