...
const config = {
  ...
  formConfig: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          initialOptionIndex: 0,
          options: [
            { label: '-- undefined --', hairstyle: '', hairLength: '', canColorHair: false },
            { label: 'Bald', hairstyle: 'bald', hairLength: '', canColorHair: false },
            { label: 'Braids', hairstyle: 'simple braid hairstyle', hairLength: '', canColorHair: false },
            { label: 'Buzz cut', hairstyle: 'buzz haircut', hairLength: '', canColorHair: false },
            { label: 'Cornrows', hairstyle: 'cornrows hairstyle', hairLength: '', canColorHair: false },
            { label: 'Curly Long', hairstyle: 'curly hair' , hairLength: 'long', canColorHair: true },
            { label: 'Curly Short', hairstyle: 'curly hair' , hairLength: 'short', canColorHair: true },
            { label: 'Dreadlocks', hairstyle: 'dreadlocks hairstyle', hairLength: '', canColorHair: false },
            { label: 'Long hair', hairstyle: 'hair' , hairLength: 'long', canColorHair: true },
            { label: 'Long disheveled', hairstyle: 'disheveled hair' , hairLength: 'long', canColorHair: true },
            { label: 'Long straight', hairstyle: 'straight hair' , hairLength: 'long', canColorHair: true },
            { label: 'Mohawk', hairstyle: 'short mohawk hairstyle', hairLength: '', canColorHair: false },
            { label: 'Pixie cut', hairstyle: 'pixie haircut', hairLength: '', canColorHair: false },
            { label: 'Ponytail', hairstyle: 'ponytail hairstyle', hairLength: '', canColorHair: false },
            { label: 'Short hair', hairstyle: 'hair' , hairLength: 'short', canColorHair: true },
            { label: 'Short disheveled', hairstyle: 'disheveled hair' , hairLength: 'short', canColorHair: true },
            { label: 'Short straight', hairstyle: 'straight hair' , hairLength: 'short', canColorHair: true },
          ],
        },
        {
          type: 'select',
  ...
  adapter: ({
    ...
    return workflowBasicLcmBypassed;
  },
};
